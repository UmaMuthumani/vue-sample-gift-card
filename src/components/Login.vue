<template>
  <span>
    <div class="d-flex align-items-centercontainer h-100">
          ...
          <div class="col col-sm-6 col-md-6">
            <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="username" aria-describedby="User Name"
                 placeholder="Enter UserName" v-model="user.username">
              </div>
              <div class="form-group">
                <label for="userpassword">Password</label>
                <input type="password" class="form-control" id="userPassword" v-model="user.userpassword"
